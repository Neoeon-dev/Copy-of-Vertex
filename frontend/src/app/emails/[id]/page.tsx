...
<div className="rounded-2xl border border-border bg-slate-950 p-4 text-white dark:bg-[#0b1220]"><div className="mb-3 flex items-center justify-between gap-3"><span className="text-xs font-black uppercase tracking-[.12em] text-slate-300">Approximate network map</span><span className="text-right text-[10px] text-slate-400">{mapped.length} mapped</span></div><GeoMap points={mapped}/><div className="mt-2 text-[9px] leading-4 text-slate-400">Coordinates are approximate IP geolocation, not physical-address evidence.</div></div>
